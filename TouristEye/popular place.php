...
<title>TouristEye Bangladesh: Popular places</title>
...
<body>
 ...
 <div class="w3-display-container w3-text-white">
    <img src="pop1.jpg" width="1380"  height="500" style="margin-left:-5px; margin-top:-20px;" >
    <div class="w3-display-topleft w3-container" style="background-color:darkslategray; margin-top:40px;margin-left: 70px;opacity:0.6; ">
      <h4 style="font-family:Tahoma, Geneva, sans-serif; font-size-adjust: .70; color:white; padding:20px; line-height:1.8;">Find the most popular places.<br> Make them your destination</h4>
    </div>
</div>

<div >
    <h3 style="margin-top:40px;text-align: center;font-size:30px;font-weight:595;font-size-adjust: .70;">Popular Places</h3>
    <p style="text-align:center;font-size:20px;font-size-adjust:.58;color:#595959;">Came to Bangladesh. Now where should I go first?<br> Let us help you to choose the most popular places. <br>Relax !</p>
    <p style="text-align:justify;width:700px; font-size-adjust:.60; margin-left:320px; color:#333333;"> Exploring Bangladesh's most popular places will give you chance to determine why they are so popular. The tradition, culture and the beauty of different popular places will definately change your outlook and perspective about life. <br> <br> If you are after Bangladesh's famous and popular place, there's a myriad to choose from. For adventure lovers this could be a place for kiss and tell.</p> 
 </div>
...
<div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="nilgiri.jpg"  width="300" height="300" class="w3-hover-opacity">
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">Nilgiri</div>
  </a>
</div>
</div>
...
<div class="imgpop">
  <div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="lalbag.jpg" width="300" height="300" class="w3-hover-opacity">
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">Lalbag Fort</div>
  </a>
</div>
</div>
...
<div style="margin-top:750px;" style="clear:left;">
 ...
 <div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="panam.jpg" width="300" height="300" class="w3-hover-opacity" >
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">Panam City</div>
  </a>
</div>
</div>
...
<div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="ahsan.jpg"  width="300" height="300" class="w3-hover-opacity">
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">Ahsan Manjil</div>
  </a>
</div>
</div>
...
<div class="imgpop">
  <div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="paharpur.jpg" width="300" height="300" class="w3-hover-opacity">
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">Sompura Mahavihara</div>
  </a>
</div>
</div>
...
<div class="w3-display-container">
  <a target="_blank" href="#">
    <img src="parliament.jpg"  width="300" height="300" class="w3-hover-opacity">
    <div class="w3-display-bottomleft w3-large w3-container w3-padding-14 w3-deep-orange" style="">National Parliament</div>
  </a>
</div>
</div>
...
<div>
    <h3 style="margin-top:1100px;text-align: center;font-size:30px;font-weight:595;font-size-adjust: .70; color:darkolivegreen;">Why wait ? Give a tour now !</h3>
 </div>


 <div style="margin-bottom:-33px; max-width:1920px; margin-left:-200px;margin-right:-200px; margin-top:50px;clear:left;">
